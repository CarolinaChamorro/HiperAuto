...
// Emisores o Sucursales
var registroEmisor = [
    new Emisor("1", "Lauren Jauregui", "Magdalena", "Quito", "Sucursal Sur"),
    new Emisor("2", "Justin Bieber", "Santa Barbara", "Quito", "Concesionaria Nissan"),
    new Emisor("3", "Camila Cabello", "Sangolqui", "Quito", "Sucursal Valle"),
]
...
document.getElementById("enviar")
    .addEventListener("click", function () {
        ...
        if (typeof emisor === "undefined") {
            ...
            //INSECCION DE DATOS EN INPUTS RESPECTIVOS
